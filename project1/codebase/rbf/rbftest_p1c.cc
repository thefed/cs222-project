...
int RBFtest_private_1c(RecordBasedFileManager *rbfm) {
	...
	// Setting attr0, attr10, and attr17 as NULL.
	// Each of theses attributes is placed as the left-most bit in each byte.
	// The entire byte representation is: 100000000010000001000000
	//                                    123456789012345678901234
	nullsIndicator[0] = 128; // 10000000
	nullsIndicator[1] = 32; // 00100000
	nullsIndicator[2] = 64; // 01000000
