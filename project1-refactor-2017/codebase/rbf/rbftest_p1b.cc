...
int RBFtest_private_1b(RecordBasedFileManager *rbfm) {
	...
	// Setting the send_time(4th) and message_text(6th) field value as null
	nullsIndicator[0] = 20; // 00010100
	
    // Insert a record into a file
	prepareRecordForTweetMessage(recordDescriptorForTweetMessage.size(), nullsIndicator, 101, 1, 123.4, 1013.45, 8, "database", 31, "Finding shortcut_menu was easy.", record, &recordSize);
    
	// The send_time(4th) and message_text(6th) fields should not be printed.
